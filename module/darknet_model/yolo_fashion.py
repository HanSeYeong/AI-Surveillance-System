    ...
    for j in range(num):
        for i in range(meta.classes):
            if dets[j].prob[i] > 0.5:
                ...
                accuracies.append(round(dets[j].prob[i] * 100))
...
class YOLO_fashion:
    def __init__(self):
        ...
        configPath = "module/darknet_model/model_data/model_fashion/deepfashion2.cfg"
        weightPath = "module/darknet_model/model_data/model_fashion/deepfashion2_30000.weights"
        metaPath = "module/darknet_model/model_data/model_fashion/deepfashion2.data"
    ...
    def detect_image(self, image):
        h, w = image.shape[:-1]
        self.ratio_h = h / self.Height
        self.ratio_w = w / self.Width
